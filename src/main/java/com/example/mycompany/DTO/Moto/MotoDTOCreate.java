...
public class MotoDTOCreate {
    ...
    public MotoDTOCreate() {
    }

    public MotoDTOCreate(String registrationNumber, String fuelType, String numberOfSeats, String bodyColor, String bodyType, String yearOfTheMoto, Long motoModel) {
