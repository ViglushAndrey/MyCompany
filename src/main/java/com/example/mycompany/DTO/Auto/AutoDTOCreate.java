...
public class AutoDTOCreate {
    ...
    public AutoDTOCreate() {
    }

    public AutoDTOCreate(String registrationNumber, String fuelType, String numberOfSeats, String numberOfDoors, String bodyColor, String bodyType, String yearOfTheCar, Long carModel) {
